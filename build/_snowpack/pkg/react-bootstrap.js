...
function useGlobalListener(event, handler, capture) {
  ...
  var documentTarget = react.useCallback(function () {
    return document;
  }, []);
...
function useRootClose(ref, onRootClose, {
  ...
  const preventMouseRootCloseRef = react.useRef(false);
...
function useWrappedRefWithWarning(ref, componentName) {
  // @ts-ignore
  return ref; // eslint-disable-next-line react-hooks/rules-of-hooks
}
...
DropdownMenu$1.defaultProps = defaultProps$3;
...
const DropdownToggle$1 = /*#__PURE__*/react.forwardRef(({
  ...
  toggleProps.ref = useMergedRefs(toggleProps.ref, useWrappedRefWithWarning(ref)); // This intentionally forwards size and variant (if set) to the
...
const Dropdown$1 = /*#__PURE__*/react.forwardRef((pProps, ref) => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(DropdownContext$1.Provider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(Dropdown, {
      ...
      children: isInputGroup ? props.children : /*#__PURE__*/jsxRuntime.jsx(Component, { ...props,
        ref: ref,
...
Dropdown$1.defaultProps = defaultProps$4;
var Dropdown$2 = Object.assign(Dropdown$1, {
...
const DropdownButton = /*#__PURE__*/react.forwardRef(({
  ...
  menuVariant,
  ...props
}, ref) => /*#__PURE__*/jsxRuntime.jsxs(Dropdown$2, {
  ref: ref,
  ...props,
  children: [/*#__PURE__*/jsxRuntime.jsx(DropdownToggle$1, {
    id: id,
    href: href,
    size: size,
    variant: variant,
...
Nav$1.defaultProps = defaultProps$8;
...
const _excluded$7 = ["active", "eventKey", "mountOnEnter", "transition", "unmountOnExit"],
...
function useTabPanel(_ref) {
  let {
    ...
    unmountOnExit
      ...
      props = _objectWithoutPropertiesLoose$8(_ref, _excluded$7);
  ...
  const {
    ...
    getControllerId
        ...
        rest = _objectWithoutPropertiesLoose$8(context, _excluded2);
...
(_ref2, ref) => {
  let {
    as: Component = 'div'
      ...
      props = _objectWithoutPropertiesLoose$8(_ref2, _excluded3);
...
Tabs$1.defaultProps = defaultProps$9;
Tabs$1.displayName = 'Tabs';

export { Button$1 as Button, Col, Container, Dropdown$2 as Dropdown, DropdownButton, Fade, Form$1 as Form, Row, Tab$1 as Tab, Table, Tabs$1 as Tabs };
